        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
              ...
              <button id="btnExportar"  class="btn btn-success btn-sm btn-flat"><i class="fa fa-file-excel-o"></i> Exportar</button>
            </div>
...
<!-- script para exportar a excel -->
    ...
    $btnExportar.addEventListener("click", function() {
        let tableExport = new TableExport($tabla, {
            ...
            filename: "Reporte de Asistencia Extra", //Nombre del archivo de Excel
            sheetname: "Reporte de Asistencia Extra", //Título de la hoja
        });
