...
<div class="login-box">
      ...
      <img src="images/images.jpg" height="250px" width="250px" alt="logotipo del sitio" />
      </div>
    	<h4 class="login-box-msg">Ingrese su DNI de Aspirante</h4>
...
$(function() {
  var interval = setInterval(function() {
    ...
    $('#date').html(momentNow.format('dddd').charAt(0).toUpperCase() + momentNow.format('dddd').slice(1).toLowerCase() + ' - ' + momentNow.format('DD MMMM , YYYY'));  
